...
export default function Footer({ border = false }: { border?: boolean }) {
  ...
  return (
    <footer className="relative">
      {/* Full footer — kept in DOM, hidden from view */}
      <div className="hidden" aria-hidden="true">
        <div className="my-8 h-px w-full bg-gradient-to-r from-transparent via-gray-300 to-transparent opacity-60" />
        ...
        <div className="relative -mt-12 h-16 w-full overflow-hidden md:h-48">
          <div
      ...
      <div className="border-t border-gray-200/80 bg-white">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-4 py-5 sm:flex-row sm:px-6">
          <p className="text-xs text-gray-500">© 2026 Clearform. All rights reserved.</p>
