...
export const PILOT_TERMS_LINE =
  "3-month pilot — workspace, AI pipeline, onboarding & exports. Subscribe only if it's working.";

export const INCLUDED_ITEMS = [
  "Unlimited forms · 300 responses · 1 workspace",
  "AI Logic, Insights, Quality Scoring & Analytics",
  "Google Sheets, Drive & Slack",
  "Guided onboarding & structured exports",
];
